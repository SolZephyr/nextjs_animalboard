    ...
    return (
        <ContentMain>
            <div className="flex flex-col gap-2">
                <section className="p-4 border border-border rounded-md bg-card text-card-foreground">
                ...
                <section className="p-4 border border-border rounded-md bg-card text-card-foreground">
                    ...
                    <form action="" className="flex flex-col gap-2 my-4">
                        ...
                        <input type="email" name="email" id="email" placeholder="name@example.com" className="border border-border rounded-md p-2 bg-input" />
                        <label htmlFor="title">Title</label>
                        <input type="text" name="title" id="title" placeholder="Your title here..." className="border border-border rounded-md p-2 bg-input" />
                        <label htmlFor="text">Details</label>
                        <textarea name="text" id="text" cols={10} placeholder="Your text here..." className="border border-border rounded-md p-2 bg-input"></textarea>
